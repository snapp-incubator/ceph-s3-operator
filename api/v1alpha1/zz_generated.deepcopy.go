...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TotalQuota) DeepCopyInto(out *TotalQuota) {
	*out = *in
	out.MaxSize = in.MaxSize.DeepCopy()
	out.MaxObjects = in.MaxObjects.DeepCopy()
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TotalQuota.
func (in *TotalQuota) DeepCopy() *TotalQuota {
	if in == nil {
		return nil
	}
	out := new(TotalQuota)
