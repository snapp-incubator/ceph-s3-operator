...
func (in *S3Quota) DeepCopyInto(out *S3Quota) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3Quota.
func (in *S3Quota) DeepCopy() *S3Quota {
	if in == nil {
		return nil
	}
	out := new(S3Quota)
...
func (in *S3UserClaimSpec) DeepCopyInto(out *S3UserClaimSpec) {
	*out = *in
	if in.ReadOnlySecret != nil {
		in, out := &in.ReadOnlySecret, &out.ReadOnlySecret
		*out = new(string)
		**out = **in
	}
}
